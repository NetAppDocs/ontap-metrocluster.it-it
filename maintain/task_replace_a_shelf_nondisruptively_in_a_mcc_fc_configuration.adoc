...
---
= Sostituisci uno shelf senza interruzioni in una configurazione FC collegata a fabric MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/mcc_shelf_replacement_bridges_with_a_single_stack.gif[Ponti di sostituzione degli scaffali con pila singola]
...
+
image::../media/mcc_shelf_replacement_bridges_with_four_stacks.gif[Ponti di sostituzione degli scaffali con quattro pile]
