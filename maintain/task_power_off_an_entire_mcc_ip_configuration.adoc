...
---
= Spegnere un'intera configurazione IP MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Spegnere l'intera configurazione IP di MetroCluster e tutte le apparecchiature prima di iniziare la manutenzione o lo spostamento.
...
. Verificare la configurazione di MetroCluster da entrambi i siti.
+
...
NOTE: In una configurazione IP MetroCluster, il dominio di errore AUSO è già impostato su 'auso-disabled' a meno che la configurazione non utilizzi ONTAP Mediator.
	...
	cluster_A_site_A::*> metrocluster operation show
      ...
      Start Time: 4/25/2020 20:20:36
        End Time: 4/25/2020 20:20:36
          Errors: -
----
. Arresta i nodi in entrambi i siti:
+
[listing]
----
