...
.. Configurare il nuovo switch come descritto in _Installazione e configurazione di MetroCluster, ignorando la procedura "`Configurazione dello zoning sugli switch FC Brocade`".
+
