...
+
Seguire la procedura per l'installazione del software switch nell'argomento pertinente delle informazioni _Installazione e configurazione IP MetroCluster_ a seconda che il tipo di switch sia Broadcom, Cisco o NVIDIA:
