...
** link:../install-ip/task_switch_config_cisco.html#download-and-install-the-cisco-switch-nx-os-software["Scaricare e installare il software Cisco switch NX-OS"]
