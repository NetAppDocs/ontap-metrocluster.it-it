...
. Spostare i dati dai vecchi nodi ai nuovi nodi seguendo le procedure descritte in link:https://docs.netapp.com/us-en/ontap-systems-upgrade/index.html["Documentazione dei sistemi hardware ONTAP"^]
+
