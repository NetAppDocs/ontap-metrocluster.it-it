...
---
= Aggiornamenti supportati del controller IP MetroCluster tramite la sostituzione del controller di sistema
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Nota 3: Gli upgrade dei sistemi integrati (dischi e controller nello stesso chassis) richiedono la sostituzione dei moduli controller mantenendo lo chassis e i dischi esistenti.
...
* Nota 5: Richiede ONTAP 9.18.1GA o versioni successive.
...
image:../media/assisted-group-2-a70-a90-updated.png["Mostra le combinazioni di aggiornamento AFF e FAS gruppo 2"]
