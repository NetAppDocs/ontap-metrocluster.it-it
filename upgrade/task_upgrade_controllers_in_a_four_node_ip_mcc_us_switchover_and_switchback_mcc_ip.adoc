...
* Se è abilitato nel sistema, link:../maintain/task-configure-encryption.html#disable-end-to-end-encryption["Disattiva la crittografia end-to-end"] prima di eseguire l'aggiornamento del controller.
