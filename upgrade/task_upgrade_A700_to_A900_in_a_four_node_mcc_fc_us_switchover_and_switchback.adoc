...
. Utilizzare i passaggi indicati in: link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#add-metrocluster-configurations["Aggiunta di configurazioni MetroCluster"] nella sezione _Installazione e configurazione di MetroCluster Tiebreaker_.
