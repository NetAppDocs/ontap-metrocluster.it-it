...
---
= Riassegna i dischi dell'aggregato root al nuovo controller IP MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
.Fasi
. Collega tutti gli altri cavi che erano stati scollegati dai vecchi controller ai nuovi moduli controller.
