...
+
link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#remove-metrocluster-configurations["Rimuovere le configurazioni MetroCluster"]
...
. Se si utilizza la crittografia del volume root, a seconda della versione di ONTAP in uso, selezionare l'opzione del menu di boot o immettere nuovamente il comando del menu di boot per la configurazione della gestione delle chiavi.
+
[role="tabbed-block"]
====
.ONTAP 9.8 e versioni successive
