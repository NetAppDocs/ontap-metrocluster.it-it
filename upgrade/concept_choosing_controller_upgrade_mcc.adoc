...
---
= Scegli una procedura di aggiornamento del controller MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Nota 4: Gli aggiornamenti dei sistemi integrati (dischi e controller nello stesso chassis) richiedono la sostituzione dei moduli controller mantenendo lo chassis e i dischi esistenti.
...
image:../media/manual-upgrade-combination-group-2-a90-fas90-updated.png["Mostra le combinazioni di aggiornamento supportate per le piattaforme del gruppo 2"]
...
image::../media/metrocluster_fc_upgrade_table_aff_fas.png[Combinazioni di piattaforme supportate per gli aggiornamenti del controller MetroCluster FC]
