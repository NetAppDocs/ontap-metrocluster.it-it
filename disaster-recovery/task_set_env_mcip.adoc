...
+
** È necessario l'ID VLAN se i modelli di piattaforma utilizzano gli ID VLAN (vedere l'elenco sopra riportato) e se non si utilizzano gli ID VLAN predefiniti.
...
[NOTE]
====
** Se le interfacce utilizzano le VLAN predefinite o se il modello di piattaforma non utilizza un ID VLAN (vedere l'elenco sopra riportato), _vlan-id_ non è necessario.
