...
Le tabelle seguenti mostrano l'utilizzo delle porte su uno switch Cisco 9132T. Le tabelle mostrano le configurazioni massime supportate con quattro e otto moduli controller in due gruppi DR.
...
4+| Cisco 9132T con 2x LEM e un gruppo MetroCluster o DR a quattro nodi 
...
4+| Cisco 9132T con due MetroCluster a quattro nodi o un MetroCluster a otto nodi con due gruppi DR 
