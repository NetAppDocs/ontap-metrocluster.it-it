...
---
= Eseguire la transizione dei nodi FC MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
| Ripiani e numero di dischi in ciascun ripiano, dettagli sulla memoria flash, memoria, NVRAM e schede di rete | nodo di sistema run -node node_name sysconfig |  
