...
---
= Configura MetroCluster per la transizione
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Se si utilizza Onboard Key Manager, eseguire i seguenti passaggi dal cluster in cui è stato aggiunto un nuovo nodo:
+
.. Sincronizzare la configurazione del gestore delle chiavi:
+
`security key-manager onboard sync`

.. Quando richiesto, immettere la passphrase di Onboard Key Manager.
