...
---
= Genera e applica gli RCF ai nuovi switch IP MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Se stai eseguendo una transizione da FC a quattro nodi a IP a otto nodi, puoi applicare l'RCF da FC a quattro nodi a IP a otto nodi prima di aggiungere il secondo gruppo DR. Non devi applicare prima l'RCF da FC a quattro nodi a IP a quattro nodi.
