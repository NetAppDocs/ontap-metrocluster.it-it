...
---
= Requisiti per distribuire configurazioni IP MetroCluster in reti condivise di livello 2 o livello 3
:allow-uri-read: 
...
image::../media/MCC_layer2.png[Configurazione di rete di livello 2 MetroCluster]
...
image::../media/mcc_layer3_backend.png[Configurazione della rete backend di livello 3 MetroCluster]
...
image::../media/switch_traffic_with_cisco_switches.png[Impostazioni richieste quando si utilizzano switch Cisco convalidati da NetApp per il traffico MetroCluster]
...
image::../media/switch_traffic_with_broadcom_switches.png[Impostazioni richieste per la rete condivisa quando si utilizzano switch IP Broadcom]
