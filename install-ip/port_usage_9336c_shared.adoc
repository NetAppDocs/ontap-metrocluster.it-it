...
* Quando si collega uno switch Cisco 9336C-FX2 che connette lo storage NS224, è possibile avere un massimo di due configurazioni o gruppi DR MetroCluster. Almeno una configurazione o un gruppo DR MetroCluster deve collegare shelf NS224 allo switch MetroCluster. Se una delle configurazioni o dei gruppi DR MetroCluster è un sistema che non supporta shelf NS224, può essere collegata solo come seconda configurazione o gruppo DR MetroCluster.
+
