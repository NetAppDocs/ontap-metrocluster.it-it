...
---
= Installa il file di configurazione Ethernet Switch Health Monitor per uno switch IP NVIDIA SN2100 MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:configure-cshm-mccip.html["Configurare il monitoraggio dello stato dello switch"].
