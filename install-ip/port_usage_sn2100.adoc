...
image::../media/mccip-cabling-fas90-fas70-aff-a70--a90-c80-a1k-nvidia-sn2100-updated.png[Mostra le assegnazioni delle porte della piattaforma NVIDIA SN2100]
