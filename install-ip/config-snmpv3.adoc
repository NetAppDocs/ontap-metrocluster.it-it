...
Questa attività illustra i passaggi generici per la configurazione di SNMPv3 su uno switch. Alcune delle versioni del firmware dello switch elencate potrebbero non essere supportate in una configurazione IP MetroCluster.
