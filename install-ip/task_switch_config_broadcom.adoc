...
----
.. Se si utilizza la versione conforme a FIPS di EFOS, generare le chiavi ECDSA. Nell'esempio seguente vengono create le chiavi con una lunghezza di 256. I valori validi sono 256, 384 o 521.
+
[listing]
----
(Routing) #configure
