...
+
** A partire da ONTAP 9.18.1, le piattaforme con una velocità di porta back-end IP MetroCluster di 100Gbps richiedono una velocità di collegamento ISL minima di 100Gbps. L'utilizzo di una velocità ISL diversa richiede una Feature Product Variance Request (FPVR). Per presentare una FPVR, contatta il tuo team di vendita NetApp.
+
