...
+
** A partire da ONTAP 9.18.1, le piattaforme con una velocità della porta backend IP MetroCluster di 100G richiedono una velocità minima di collegamento ISL di 100Gbps. L'utilizzo di una velocità ISL diversa richiede una richiesta di variazione delle funzionalità (FPVR). Per presentare un FPVR, contatta il team di vendita NetApp .
