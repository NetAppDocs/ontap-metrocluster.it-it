...
+
** Sui sistemi AFF A1K e AFF A90 , la velocità ISL deve essere almeno di 100 Gbps. L'utilizzo di una velocità ISL diversa richiede una richiesta di variazione del prodotto caratteristica (FPVR). Per presentare un FPVR, contatta il tuo team di vendita.
** Su tutte le altre piattaforme, la velocità ISL deve essere almeno di 10 Gbps.
