...
---
= Dove trovare ulteriori informazioni su MetroCluster Tiebreaker
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Tutte le informazioni MetroCluster
 ...
 a| 
https://www.netapp.com/pdf.html?item=/media/13482-tr4375.pdf["Report tecnico NetApp 4375: NetApp MetroCluster per ONTAP 9.3"^]
 a| 
