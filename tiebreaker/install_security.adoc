...
---
= Proteggi l'host Tiebreaker MetroCluster e l'installazione del database
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
** La crittografia dei dati a riposo è supportata. link:https://mariadb.com/docs/server/security/encryption/data-at-rest-encryption/data-at-rest-encryption-tde-fundamentals["Scopri di più sulla crittografia dei dati a riposo"^]
...
link:install-choose-procedure.html["Scegli la procedura di installazione del tuo MetroCluster Tiebreaker"] per installare o aggiornare Tiebreaker.
