...
summary: Eseguire una nuova installazione o un aggiornamento a tiebreaker 1,6 sul sistema operativo Linux host per monitorare le configurazioni MetroCluster. 
---
= Installa MetroCluster Tiebreaker 1.6 o 1.6P1
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Eseguire una nuova installazione o un aggiornamento a tiebreaker 1,6 o tiebreaker 1.6P1 sul sistema operativo Linux host per monitorare le configurazioni MetroCluster.
...
NOTE: Dopo aver installato Tiebreaker 1.6 o versioni successive, è necessario link:concept_configuring_the_tiebreaker_software.html#import-certificates-tb17["importa certificati"] per abilitare il monitoraggio continuo.



[[install-or-upgrade-to-tiebreaker-1-6p1]]
== Installare o aggiornare a tiebreaker 1.6P1

È possibile installare Tiebreaker 1.6P1 o eseguire l'aggiornamento a Tiebreaker 1.6P1 da Tiebreaker 1,6, 1,5 o 1,4.

.Fasi
. Scaricare il software MetroCluster Tiebreaker 1.6P1.
+
...
. Se si sta eseguendo un aggiornamento, verificare la versione di tiebreaker in esecuzione:
+
...
----
. Installare o aggiornare il software Tiebreaker.
+
[role="tabbed-block"]
====
.Installare il Tiebreaker 1.6P1
--
Per una nuova installazione di Tiebreaker 1.6P1, procedere come segue.
...
--
.Aggiornamento da 1,6 a 1.6P1
--
Per aggiornare la versione del software Tiebreaker 1,6 a tiebreaker 1.6P1, procedere come segue.


NOTE: Dopo aver eseguito l'aggiornamento a tiebreaker 1.6P1 da 1,6, rimuovere i monitor esistenti e aggiungere nuovamente la configurazione MetroCluster per il monitoraggio.
...
----
=====
.. Rimuovere e aggiungere nuovamente la configurazione MetroCluster seguendo la procedura descritta in link:concept_configuring_the_tiebreaker_software.html["Configurare il software Tiebreaker"].


--
.Aggiornamento da 1,5 a 1.6P1
--
Per aggiornare la versione del software Tiebreaker 1,5 a tiebreaker 1.6P1, procedere come segue.
...
--
.Aggiornamento da 1,4 a 1.6P1
--
Per aggiornare la versione del software Tiebreaker 1,4 a tiebreaker 1.6P1, procedere come segue.
...
== Installare o aggiornare a tiebreaker 1,6

È possibile installare Tiebreaker 1,6 o eseguire l'aggiornamento a Tiebreaker 1,6 da Tiebreaker 1,5 o 1,4.

.Fasi
. Scaricare il software MetroCluster Tiebreaker 1,6.
+
https://mysupport.netapp.com/site/products/all/details/metrocluster-tiebreaker/downloads-tab["MetroCluster Tiebreaker (Download) - Sito di supporto NetApp"^]
...
Dopo aver installato o aggiornato correttamente Tiebreaker, link:configure-tb-workflow.html["configurare il software MetroCluster Tiebreaker"] per aggiungere le configurazioni MetroCluster e importare i certificati richiesti.
