...
---
= Scegli la procedura di installazione del tuo MetroCluster Tiebreaker
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Spareggio 1.7
 a| 
link:tb-17-install.html["Installa Tiebreaker 1.7"]
...
Spareggio 1.6 o 1.6P1
 a| 
link:tb-16-install.html["Installa MetroCluster Tiebreaker 1.6 o 1.6P1"]
