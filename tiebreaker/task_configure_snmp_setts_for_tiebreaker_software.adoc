...
---
= Configurare le impostazioni SNMP per il software MetroCluster Tiebreaker
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:concept_monitoring_the_mcc_configuration.html["Monitorare la configurazione di MetroCluster"]
