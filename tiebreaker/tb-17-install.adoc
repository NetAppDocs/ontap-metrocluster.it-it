...
---
= Installa MetroCluster Tiebreaker 1.7
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Installa o esegui l'aggiornamento a Tiebreaker 1.7 sul tuo host Linux per monitorare le configurazioni MetroCluster .

.A proposito di questa attività
* Il sistema storage deve eseguire ONTAP 9.12.1 o versione successiva.
* È possibile passare da Tiebreaker 1.6P1 a Tiebreaker 1.7 solo. Fare riferimento alink:tb-16-install.html["Installa Tiebreaker 1.6 o 1.6P1"] .
...
NOTE: Dopo aver installato Tiebreaker 1.7, è necessario link:concept_configuring_the_tiebreaker_software.html#import-certificates-tb17["importa certificati"] per abilitare il monitoraggio continuo.

.Fasi
. Scarica il software MetroCluster Tiebreaker 1.7.
+
...
. Se stai effettuando l'aggiornamento, controlla quale versione di Tiebreaker stai utilizzando:
+
L'esempio seguente mostra Tiebreaker 1.6P1
...
[role="tabbed-block"]
====
.Installa Tiebreaker 1.7
--
Per una nuova installazione di Tiebreaker 1.7, attenersi alla seguente procedura.
...
--
.Aggiorna 1.6P1 a 1.7
--
Per aggiornare la versione del software Tiebreaker 1.6P1 alla versione Tiebreaker 1.7, procedere come segue.
...
NOTE: Se l'aggiornamento non riesce con un errore dovuto a certificati mancanti, fare riferimento alink:../tiebreaker/concept_configuring_the_tiebreaker_software.html#import-certificates-tb17["Certificati di importazione"] .  Dopo aver importato i certificati, puoi provare a effettuare nuovamente l'aggiornamento.
