...
---
= MetroCluster Requisiti di installazione di Tiebreaker
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Fare riferimento a. link:whats_new.html#os-support-matrix["Matrice di supporto del sistema operativo"] per ulteriori informazioni.
 a| 
Nessuno. OpenJDK 19.0.2 è incluso nell'installazione.
...
* Se stai installando o aggiornando a Tiebreaker 1.5 o versioni successive, link:install_security.html["Proteggi l'host Tiebreaker MetroCluster e l'installazione del database"].
* Se stai installando o aggiornando a Tiebreaker 1.4, link:install-dependencies-14.html["Installare le dipendenze di MetroCluster tiebreaker 1,4"].
