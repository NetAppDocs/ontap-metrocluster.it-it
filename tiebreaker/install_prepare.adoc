...
* Se stai installando o aggiornando a Tiebreaker 1.5 o versioni successive, link:install_security.html["Proteggere l'installazione dell'host tiebreaker e del database"].
