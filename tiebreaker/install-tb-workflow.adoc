...
---
= MetroCluster Tiebreaker flusso di lavoro per l'installazione
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["Uno"]link:install_prepare.html["MetroCluster Requisiti di installazione di Tiebreaker"]
