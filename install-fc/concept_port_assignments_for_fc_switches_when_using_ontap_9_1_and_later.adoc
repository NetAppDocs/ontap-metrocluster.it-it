...
=== Configurazioni di shelf che utilizzano FibreBridge 7500N o 7600N usando entrambe le porte FC (FC1 o FC2)

.MetroCluster 1 o DR 1
Nella tabella seguente sono illustrate le configurazioni shelf supportate in MetroCluster 1 o DR Group 1 per bridge FibreBridge 7500N o 7600N, utilizzando entrambe le porte FC (FC1 o FC2). Quando si utilizza questa tabella di configurazione, è necessario tenere presente quanto segue:
...
|===
È possibile collegare altri ponti utilizzando le porte da 25 a 48 seguendo lo stesso schema.
