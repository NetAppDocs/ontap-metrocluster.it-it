...
* <<cabling_fb_6500N_with_iom6_iom3,Collegamento di un bridge FibreBridge 6500N con shelf di dischi utilizzando moduli IOM6 o IOM3>>
...
----
+ NOTA: Se all'inizio dell'output viene visualizzato il testo "`respesse tronced`", è possibile utilizzare Telnet per connettersi al bridge e immettere lo stesso comando per visualizzare l'output.
