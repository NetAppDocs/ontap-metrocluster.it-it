...
== Numero di dischi e shelf supportati sui bridge FibreBridge 7600N e 7500N

Nelle tabelle seguenti viene indicato il numero di dischi e shelf supportati dietro una coppia di bridge FibreBridge 7600N e 7500N.

[NOTE]
====
* Si applica il primo limite raggiunto.
* Se utilizzi DS460C shelf, è possibile utilizzare solo un massimo di 240 dischi, ovvero 4 shelf.
* Se utilizzi DS212C shelf, è possibile utilizzare solo un massimo di 120 dischi, ovvero 10 shelf.


====
.Numero di dischi supportato
Esaminare il numero di dischi supportati dietro una coppia di bridge FibreBridge 7600N o 7500N:

[cols="3*"]
|===
| Configurazione disco | Tipo di disco | Dischi totali per coppia di bridge 


| Tutti gli SSD | SSD | 96 


| Tutti gli HDD | DISCO RIGIDO | 240 


.2+| Misto (SSD da 96 TB) | SSD | 96 


| DISCO RIGIDO | 144 


.2+| Misto (SSD da 72 TB) | SSD | 72 


| DISCO RIGIDO | 168 


.2+| Misto (SSD da 48 TB) | SSD | 48 


| DISCO RIGIDO | 192 


.2+| Misto (SSD da 24 TB) | SSD | 24 


| DISCO RIGIDO | 216 
|===
.Numero di shelf supportato
Analisi del numero di shelf supportati dietro due ponti FibreBridge 7600N e 7500N:

[cols="3*"]
|===
| Configurazione disco | Tipo di disco | Numero totale di shelf 


| Tutti gli SSD | SSD | 4 


| Tutti gli HDD | DISCO RIGIDO | 10 
