...
* In una configurazione IP di MetroCluster, seguire la procedura descritta in link:https://docs.netapp.com/us-en/ontap-metrocluster/install-ip/task_sw_config_verify_haconfig.html["Ripristinare le impostazioni predefinite del sistema su un modulo controller"].
