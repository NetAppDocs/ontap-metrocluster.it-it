...
---
= Considerazioni ONTAP per le configurazioni MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/svm_dr_image_2.gif[Ripristino di emergenza SVM dopo il passaggio]
...
Consulta la sezione "Replicating the SVM configuration" nel link:http://docs.netapp.com/ontap-9/topic/com.netapp.doc.pow-dap/home.html["Protezione dei dati con la CLI"^] per i dettagli sulla configurazione di una relazione SVM DR.
