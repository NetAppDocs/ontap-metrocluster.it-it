...
---
= Configura manualmente gli switch Brocade FC in una configurazione FC MetroCluster
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Se si utilizza una versione precedente a FOS 9.0, verificare che lo switch utilizzi il metodo di licenza dinamico Port on Demand (POD).
+
